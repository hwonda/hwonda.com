...
export const aquaFarm2023: Project = {
  ...
  description: {
    ...
    full: `CSS Grid를 사용해 수조 상태, 어종 정보, 캘린더, CCTV 등의 정보를 표출하는 대시보드를 구현했습니다.
      사료 잔량과 사료공급장치의 상태를 시각화하는 모니터링 페이지를 구현하고, 오류 시 알림 기능을 만들어 관리자 메일 및 SNS 알림을 발송합니다.
      사료공급 및 개인 일정을 관리할 수 있는 캘린더 기능을 추가하고, 오픈소스 Vue-datepicker를 래핑하여 솔루션의 톤 앤 매너를 통일했습니다.
