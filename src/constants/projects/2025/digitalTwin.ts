...
export const digitalTwin: Project = {
  ...
  description: {
    ...
    full: `어획량 예측 웹 프론트엔드 개발을 담당했으며, Cesium과 GIS 레이어를 사용한 3D 지도격자를 구현했습니다.
      어종에 따른 어획량을 icon의 크기 및 색상으로 표출하여 직관성을 향상시켰고, 비교를 위해 2분할된 지도 화면에서 레이어 표출을 최적화했습니다.
      또한 갯벌 안전 내비게이션 기획, 디자인 및 웹뷰를 기획하고 있습니다.
      Figma를 활용한 모바일 웹 프로토타입을 제작하고, Flutter, React를 사용한 모바일 웹뷰를 개발 중입니다.`,
  },
  images: {
